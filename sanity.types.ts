...
export type GetPostsQueryResult = {
  _id: string;
  _type: "post";
  _createdAt: string;
  _updatedAt: string;
...
// Query: *[_type== "siteSettings"][0]{...,mainHeroImage{    ...,    hotspot,    asset->{        _id,        url    }    },}
export type SiteSettingsQueryResult = {
  ...
  socials?: Array<{
    platform?: "facebook" | "instagram" | "linkedin" | "other" | "twitter" | "youtube";
    url?: string;
    _type: "socialLink";
    _key: string;
  }>;
